...
void task2() {
    ...
    rassert(array2d.size() == 2, "vector a should of size 2!");
    rassert(row1.size() == 3, "vector a should of size 3!");
...
void task3() {
    ...
    std::vector<std::vector<int>> array; // это динамический массив в котором каждый элемент - тоже динамический массив
    array.resize(n);
    ...
    for (int i = 0; i < array.size(); ++i) { // пробегаем по каждой строке

        int e = array[i].size(); // узнаем число элементов в текущей строке
        for (int j = 0; j < e; ++j) {
            int value = array[i][j];// взяли j-ую строку, а из нее - i-ый элемент
    ...
    while (true) {
        ...
        for (int q = 0; q < array.size(); ++q) { // пробегаем по каждой строке
            ...
            for (int w = 0; w < e; ++w) {
                int value = array[q][w];// взяли j-ую строку, а из нее - i-ый элемент
                // выведите в консоль это число
                std::cout <<value <<" ";
            }
            std::cout<< std::endl;
